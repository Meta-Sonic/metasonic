...
#include "mts/unicode/string_view.h"
...
TEST(core, unicode_string_view) {
  {
    EXPECT_EQ(mts::ustring_view(getTestString()).count(), mts::ustring_view(getTestWString()).count());
    EXPECT_EQ(mts::ustring_view(getTestString()).count(), mts::ustring_view(getTestWString()).to_utf32().size());
  }

  {
    std::wstring a = mts::unicode::to_wide(mts::ustring_view(getTestString()));
    std::wstring aa = mts::unicode::to_wide(getTestString());
  ...
  {
    std::string a = mts::unicode::to_utf8(getTestString());
    std::string b = mts::unicode::to_utf8(getTestWString());
    EXPECT_EQ(a.size(), b.size());
  }

  {
    mts::ustring_view a(getTestString());
  ...
  {
    mts::ustring_view a(getTestWString());
